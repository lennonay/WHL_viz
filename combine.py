...
def group(data):
    ...
    data_group = data_group.rename(columns= {'5v5primarypoints':'5v5 Primary Points',
                                             'EVprimarypoints':'EV Primary Points',
                                             'primarypoints':'PP',
                                             '5v5_GF%': '5v5 Goals For %'})
